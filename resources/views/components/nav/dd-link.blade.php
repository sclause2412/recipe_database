...
@if ($show)
    <a
        {{ $attributes->merge(['href' => $link])->class([
                'block sm:inline-flex sm:items-center w-full sm:w-auto px-3 py-2 border-l-4 text-left text-base sm:text-sm font-medium focus:outline-none transition duration-150 ease-in-out',
