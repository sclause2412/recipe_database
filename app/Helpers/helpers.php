...
if (!function_exists('default_colors')) {
    function default_colors()
    {
        ...
        return [
            //Gray and black
            ['name' => __('colors.gray.Black'), 'value' => '#000000'],
            ['name' => __('colors.gray.DarkSlateGray'), 'value' => '#2f4f4f'],
            ['name' => __('colors.gray.DimGray'), 'value' => '#696969'],
            ['name' => __('colors.gray.SlateGray'), 'value' => '#708090'],
            ['name' => __('colors.gray.Gray'), 'value' => '#808080'],
            ['name' => __('colors.gray.LightSlateGray'), 'value' => '#778899'],
            ['name' => __('colors.gray.DarkGray'), 'value' => '#a9a9a9'],
            ['name' => __('colors.gray.Silver'), 'value' => '#c0c0c0'],
            ['name' => __('colors.gray.LightGray'), 'value' => '#d3d3d3'],
            ['name' => __('colors.gray.Gainsboro'), 'value' => '#dcdcdc'],
            //White
            ['name' => __('colors.white.MistyRose'), 'value' => '#ffe4e1'],
            ['name' => __('colors.white.AntiqueWhite'), 'value' => '#faebd7'],
            ['name' => __('colors.white.Linen'), 'value' => '#faf0e6'],
            ['name' => __('colors.white.Beige'), 'value' => '#f5f5dc'],
            ['name' => __('colors.white.WhiteSmoke'), 'value' => '#f5f5f5'],
            ['name' => __('colors.white.LavenderBlush'), 'value' => '#fff0f5'],
            ['name' => __('colors.white.OldLace'), 'value' => '#fdf5e6'],
            ['name' => __('colors.white.AliceBlue'), 'value' => '#f0f8ff'],
            ['name' => __('colors.white.Seashell'), 'value' => '#fff5ee'],
            ['name' => __('colors.white.GhostWhite'), 'value' => '#f8f8ff'],
            ['name' => __('colors.white.Honeydew'), 'value' => '#f0fff0'],
            ['name' => __('colors.white.FloralWhite'), 'value' => '#fffaf0'],
            ['name' => __('colors.white.Azure'), 'value' => '#f0ffff'],
            ['name' => __('colors.white.MintCream'), 'value' => '#f5fffa'],
            ['name' => __('colors.white.Snow'), 'value' => '#fffafa'],
            ['name' => __('colors.white.Ivory'), 'value' => '#fffff0'],
            ['name' => __('colors.white.White'), 'value' => '#ffffff'],
            //Red
            ['name' => __('colors.red.DarkRed'), 'value' => '#8b0000'],
            ['name' => __('colors.red.Red'), 'value' => '#ff0000'],
            ['name' => __('colors.red.Firebrick'), 'value' => '#b22222'],
            ['name' => __('colors.red.Crimson'), 'value' => '#dc143c'],
            ['name' => __('colors.red.IndianRed'), 'value' => '#cd5c5c'],
            ['name' => __('colors.red.LightCoral'), 'value' => '#f08080'],
            ['name' => __('colors.red.Salmon'), 'value' => '#fa8072'],
            ['name' => __('colors.red.DarkSalmon'), 'value' => '#e9967a'],
            ['name' => __('colors.red.LightSalmon'), 'value' => '#ffa07a'],
            //Orange
            ['name' => __('colors.orange.OrangeRed'), 'value' => '#ff4500'],
            ['name' => __('colors.orange.Tomato'), 'value' => '#ff6347'],
            ['name' => __('colors.orange.DarkOrange'), 'value' => '#ff8c00'],
            ['name' => __('colors.orange.Coral'), 'value' => '#ff7f50'],
            ['name' => __('colors.orange.Orange'), 'value' => '#ffa500'],
            //Yellow
            ['name' => __('colors.yellow.DarkKhaki'), 'value' => '#bdb76b'],
            ['name' => __('colors.yellow.Gold'), 'value' => '#ffd700'],
            ['name' => __('colors.yellow.Khaki'), 'value' => '#f0e68c'],
            ['name' => __('colors.yellow.PeachPuff'), 'value' => '#ffdab9'],
            ['name' => __('colors.yellow.Yellow'), 'value' => '#ffff00'],
            ['name' => __('colors.yellow.PaleGoldenrod'), 'value' => '#eee8aa'],
            ['name' => __('colors.yellow.Moccasin'), 'value' => '#ffe4b5'],
            ['name' => __('colors.yellow.PapayaWhip'), 'value' => '#ffefd5'],
            ['name' => __('colors.yellow.LightGoldenrodYellow'), 'value' => '#fafad2'],
            ['name' => __('colors.yellow.LemonChiffon'), 'value' => '#fffacd'],
            ['name' => __('colors.yellow.LightYellow'), 'value' => '#ffffe0'],
            //Brown
            ['name' => __('colors.brown.Maroon'), 'value' => '#800000'],
            ['name' => __('colors.brown.Brown'), 'value' => '#a52a2a'],
            ['name' => __('colors.brown.SaddleBrown'), 'value' => '#8b4513'],
            ['name' => __('colors.brown.Sienna'), 'value' => '#a0522d'],
            ['name' => __('colors.brown.Chocolate'), 'value' => '#d2691e'],
            ['name' => __('colors.brown.DarkGoldenrod'), 'value' => '#b8860b'],
            ['name' => __('colors.brown.Peru'), 'value' => '#cd853f'],
            ['name' => __('colors.brown.RosyBrown'), 'value' => '#bc8f8f'],
            ['name' => __('colors.brown.Goldenrod'), 'value' => '#daa520'],
            ['name' => __('colors.brown.SandyBrown'), 'value' => '#f4a460'],
            ['name' => __('colors.brown.Tan'), 'value' => '#d2b48c'],
            ['name' => __('colors.brown.Burlywood'), 'value' => '#deb887'],
            ['name' => __('colors.brown.Wheat'), 'value' => '#f5deb3'],
            ['name' => __('colors.brown.NavajoWhite'), 'value' => '#ffdead'],
            ['name' => __('colors.brown.Bisque'), 'value' => '#ffe4c4'],
            ['name' => __('colors.brown.BlanchedAlmond'), 'value' => '#ffebcd'],
            ['name' => __('colors.brown.Cornsilk'), 'value' => '#fff8dc'],
            //Pink
            ['name' => __('colors.pink.MediumVioletRed'), 'value' => '#c71585'],
            ['name' => __('colors.pink.DeepPink'), 'value' => '#ff1493'],
            ['name' => __('colors.pink.PaleVioletRed'), 'value' => '#db7093'],
            ['name' => __('colors.pink.HotPink'), 'value' => '#ff69b4'],
            ['name' => __('colors.pink.LightPink'), 'value' => '#ffb6c1'],
            ['name' => __('colors.pink.Pink'), 'value' => '#ffc0cb'],
            //Purple
            ['name' => __('colors.purple.Indigo'), 'value' => '#4b0082'],
            ['name' => __('colors.purple.Purple'), 'value' => '#800080'],
            ['name' => __('colors.purple.DarkMagenta'), 'value' => '#8b008b'],
            ['name' => __('colors.purple.DarkViolet'), 'value' => '#9400d3'],
            ['name' => __('colors.purple.DarkSlateBlue'), 'value' => '#483d8b'],
            ['name' => __('colors.purple.BlueViolet'), 'value' => '#8a2be2'],
            ['name' => __('colors.purple.DarkOrchid'), 'value' => '#9932cc'],
            ['name' => __('colors.purple.Fuchsia'), 'value' => '#ff00ff'],
            ['name' => __('colors.purple.Magenta'), 'value' => '#ff00ff'],
            ['name' => __('colors.purple.SlateBlue'), 'value' => '#6a5acd'],
            ['name' => __('colors.purple.MediumSlateBlue'), 'value' => '#7b68ee'],
            ['name' => __('colors.purple.MediumOrchid'), 'value' => '#ba55d3'],
            ['name' => __('colors.purple.MediumPurple'), 'value' => '#9370db'],
            ['name' => __('colors.purple.Orchid'), 'value' => '#da70d6'],
            ['name' => __('colors.purple.Violet'), 'value' => '#ee82ee'],
            ['name' => __('colors.purple.Plum'), 'value' => '#dda0dd'],
            ['name' => __('colors.purple.Thistle'), 'value' => '#d8bfd8'],
            ['name' => __('colors.purple.Lavender'), 'value' => '#e6e6fa'],
            //Blue
            ['name' => __('colors.blue.MidnightBlue'), 'value' => '#191970'],
            ['name' => __('colors.blue.Navy'), 'value' => '#000080'],
            ['name' => __('colors.blue.DarkBlue'), 'value' => '#00008b'],
            ['name' => __('colors.blue.MediumBlue'), 'value' => '#0000cd'],
            ['name' => __('colors.blue.Blue'), 'value' => '#0000ff'],
            ['name' => __('colors.blue.RoyalBlue'), 'value' => '#4169e1'],
            ['name' => __('colors.blue.SteelBlue'), 'value' => '#4682b4'],
            ['name' => __('colors.blue.DodgerBlue'), 'value' => '#1e90ff'],
            ['name' => __('colors.blue.DeepSkyBlue'), 'value' => '#00bfff'],
            ['name' => __('colors.blue.CornflowerBlue'), 'value' => '#6495ed'],
            ['name' => __('colors.blue.SkyBlue'), 'value' => '#87ceeb'],
            ['name' => __('colors.blue.LightSkyBlue'), 'value' => '#87cefa'],
            ['name' => __('colors.blue.LightSteelBlue'), 'value' => '#b0c4de'],
            ['name' => __('colors.blue.LightBlue'), 'value' => '#add8e6'],
            ['name' => __('colors.blue.PowderBlue'), 'value' => '#b0e0e6'],
            //Cyan
            ['name' => __('colors.cyan.Teal'), 'value' => '#008080'],
            ['name' => __('colors.cyan.DarkCyan'), 'value' => '#008b8b'],
            ['name' => __('colors.cyan.LightSeaGreen'), 'value' => '#20b2aa'],
            ['name' => __('colors.cyan.CadetBlue'), 'value' => '#5f9ea0'],
            ['name' => __('colors.cyan.DarkTurquoise'), 'value' => '#00ced1'],
            ['name' => __('colors.cyan.MediumTurquoise'), 'value' => '#48d1cc'],
            ['name' => __('colors.cyan.Turquoise'), 'value' => '#40e0d0'],
            ['name' => __('colors.cyan.Aqua'), 'value' => '#00ffff'],
            ['name' => __('colors.cyan.Cyan'), 'value' => '#00ffff'],
            ['name' => __('colors.cyan.Aquamarine'), 'value' => '#7fffd4'],
            ['name' => __('colors.cyan.PaleTurquoise'), 'value' => '#afeeee'],
            ['name' => __('colors.cyan.LightCyan'), 'value' => '#e0ffff'],
            //Green
            ['name' => __('colors.green.DarkGreen'), 'value' => '#006400'],
            ['name' => __('colors.green.Green'), 'value' => '#008000'],
            ['name' => __('colors.green.DarkOliveGreen'), 'value' => '#556b2f'],
            ['name' => __('colors.green.ForestGreen'), 'value' => '#228b22'],
            ['name' => __('colors.green.SeaGreen'), 'value' => '#2e8b57'],
            ['name' => __('colors.green.Olive'), 'value' => '#808000'],
            ['name' => __('colors.green.OliveDrab'), 'value' => '#6b8e23'],
            ['name' => __('colors.green.MediumSeaGreen'), 'value' => '#3cb371'],
            ['name' => __('colors.green.LimeGreen'), 'value' => '#32cd32'],
            ['name' => __('colors.green.Lime'), 'value' => '#00ff00'],
            ['name' => __('colors.green.SpringGreen'), 'value' => '#00ff7f'],
            ['name' => __('colors.green.MediumSpringGreen'), 'value' => '#00fa9a'],
            ['name' => __('colors.green.DarkSeaGreen'), 'value' => '#8fbc8f'],
            ['name' => __('colors.green.MediumAquamarine'), 'value' => '#66cdaa'],
            ['name' => __('colors.green.YellowGreen'), 'value' => '#9acd32'],
            ['name' => __('colors.green.LawnGreen'), 'value' => '#7cfc00'],
            ['name' => __('colors.green.Chartreuse'), 'value' => '#7fff00'],
            ['name' => __('colors.green.LightGreen'), 'value' => '#90ee90'],
            ['name' => __('colors.green.GreenYellow'), 'value' => '#adff2f'],
            ['name' => __('colors.green.PaleGreen'), 'value' => '#98fb98'],
        ];
    }
}
